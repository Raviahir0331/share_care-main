    ...
    const DonateLink = () => {
      ...
      <link rel="stylesheet" href="/css/bootstrap.css"/>
            ...
            <div className="owl-carousel loop-block-31">
              <div className="block-30 block-30-sm item" style={{ backgroundImage: "url('/images/con.webp')" }} data-stellar-background-ratio="0.5">
                <div className="container">
            ...
            <div className='container'>
               <div className="row">
                   <div className="col-md-4">
                        <a href="images/bhavna.jpg" className="img-hover" data-fancybox="gallery">
                          <span className="icon icon-search"></span>
                  <img src="images/bhavna.jpg" alt="Image placeholder" className="img-fluid" style={{height: '350px', objectfit: 'cover',width:'300px'}}/>
                         </a>
                    </div>
                    <div className="col-md-2"></div>
                    <div className="col-md-4">
                        <a href="images/kajal.jpg" className="img-hover" data-fancybox="gallery">
                          <span className="icon icon-search"></span>
                  <img src="images/kajal.jpg" alt="Image placeholder" className="img-fluid" style={{height: '350px', objectfit: 'cover',width:'300px'}}/>
                         </a>
                    </div>
          ...
          <h2 className="display-4 mb-3">Bhavna Nandaniya</h2>
          <p className="lead">Gmail : ahirbhavna130@gmail.com</p>
          <p className="mb-4">Contact : 9328371529 </p>
        </div> 
        
                    <div className="col-md-6 welcome-text">
          <h2 className="display-4 mb-3">Kajal Vadhvani</h2>
          <p className="lead">Gmail : kajalvadhvani@gmail.com</p>
          <p className="mb-4">Contact : 8401715797 </p>
        </div>
                </div>
             </div>
             </div>
